...
const PurchaseOrderPage: React.FC = () => {
  ...
  return (
    <div>
      <h2 style={{ marginBottom: 16 }}>采购订单</h2>
      ...
      >
        <Descriptions column={2} size="small">
          ...
          <Descriptions.Item label="要求到货日期">{editingRecord?.expectedDate}</Descriptions.Item>
          ...
          <Descriptions.Item label="应付金额">¥{editingRecord?.netAmount?.toFixed(2)}</Descriptions.Item>
